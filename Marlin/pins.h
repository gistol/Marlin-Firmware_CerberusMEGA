...
// Needed for triple extruder setup for Azteeg X3
    #define E2_STEP_PIN        27 
    ...
    #define FAN_PIN            -1 //5 // IO pin. Buffer needed - Disabled because We've defined a temp controlled fan on Pin 5
    ...
    #define HEATER_2_PIN       16 // Needed for 3rd extruder on Azteeg X3 


    #define TEMP_0_PIN         13   // ANALOG NUMBERING
    #define TEMP_BED_PIN       14   // ANALOG NUMBERING
    #define TEMP_1_PIN         15   // ANALOG NUMBERING
    #define TEMP_2_PIN         5   // ANALOG NUMBERING // Needed for 3rd thermistor on Azteeg X3 
      ...
      #define BTN_EN1 22 //37
      #define BTN_EN2 7  //35
      #define BTN_ENC -1  //the click 31 (not required for Viki
